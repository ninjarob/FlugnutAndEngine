...
public class AustinScene extends BaseGameScene {
    ...
    public void initResources() {
		...
		imageTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(imageBitmapTextureAtlas, game, "flugnut_title.png", 0, 0);
    ...
    public void initScene() {
		...
		ITextureRegion clippedRegion = TextureRegionFactory.extractFromTexture(imageBitmapTextureAtlas, 10, 10, 368, 195);
		imageSprite = new Sprite(0, 0, clippedRegion, game.getVertexBufferObjectManager()); 
